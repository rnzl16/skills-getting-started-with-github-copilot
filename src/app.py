...
activities = {
    ...
    "Art Workshop": {
        "description": "Create paintings, drawings, and mixed-media artwork in a collaborative setting",
    ...
    "Science Club": {
        "description": "Conduct experiments and explore scientific concepts through hands-on inquiry",
